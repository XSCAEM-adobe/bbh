...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-investor-services-insights-2.js
  var import_investor_services_insights_2_exports = {};
  __export(import_investor_services_insights_2_exports, {
    default: () => import_investor_services_insights_2_default
  });
  ...
  var import_investor_services_insights_2_default = {
    transform: (payload) => {
      const {
        document: document2,
        url,
  ...
  return __toCommonJS(import_investor_services_insights_2_exports);
})();
